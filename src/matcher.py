...
На выходе получается уровень уверенности:
...
# Каст и создатели фильма дают самый устойчивый признак: даже если прокатчик
...
def match_film(
    ...
    # Жёсткий фильтр: нет ни одной приметы франшизы, значит не наш фильм, точка.
